...
<html lang="en">
  <head>
    ...
    <title>public Patterns &amp; Recipes | AdminLTE 4</title>
    ...
    <meta name="title" content="public Patterns &amp; Recipes | AdminLTE 4" />
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../../public/docs/recipes.php" class="nav-link active">
      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">public Patterns &amp; Recipes</h3>
              </div>
              <div class="col-sm-6">
                ...
                <div class="card">
                  <div class="card-body">
                    <p>
                      ...
                      <a href="getting-started.php">Getting Started</a> and have a working AdminLTE
                      page to build on.
                    </p>
...
<span class="line"><span style="color:#808080">&lt;/</span><span style="color:#569CD6">div</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      ...
                      <a href="integrations.php#tabulator">Tabulator</a> —
                      <code>tables/data.php</code> in the demo has a full example.
                    </p>
...
<span class="line"><span style="color:#808080">&lt;/</span><span style="color:#569CD6">div</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      ...
                      See <a href="../../public/UI/timeline.php"><code>/UI/timeline.php</code></a> for the
                      full set.
                    </p>
...
<span class="line"><span style="color:#808080">&lt;/</span><span style="color:#569CD6">div</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      For a full-page chat application, see <code>/pages/chat.php</code> in the
                      demo.
                    </p>
...
<span class="line"><span style="color:#808080">&lt;/</span><span style="color:#569CD6">div</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      The <a href="color-mode.php">Color Mode</a>,
                      <a href="javascript/accessibility.php">Accessibility</a>, and the bundled JS
                    ...
                    <ul>
                      <li>
                        <a href="javascript/plugins-overview.php">JavaScript Plugins Overview</a> —
                        every plugin’s event names and methods
                      </li>
                      <li>
                        <a href="integrations.php">Recommended Integrations</a> — when you need
                        more than what’s in this list
                      </li>
                      <li>
                        <a href="customization.php">Customization</a> — change colours, sidebar
                        width, breakpoints
                      </li>
                    </ul>
                  </div>
