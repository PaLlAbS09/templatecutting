...
<html lang="en">
  ...
  <head>
    ...
    <title>Fullscreen Plugin | AdminLTE 4</title>
    ...
    <meta name="title" content="Fullscreen Plugin | AdminLTE 4" />
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../../../public/docs/javascript/fullscreen.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Fullscreen</p>
                    </a>
                  </li>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Fullscreen Plugin</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Docs</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Fullscreen Plugin</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
...
<span class="line"><span style="color:#9CDCFE">fs</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">outFullscreen</span><span style="color:#D4D4D4">()     </span><span style="color:#6A9955">// exit fullscreen</span></span></code></pre>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <a href="card-widget.php#programmatic-api"
