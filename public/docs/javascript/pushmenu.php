...
<html lang="en">
  ...
  <head>
    ...
    <title>Pushmenu Plugin | AdminLTE 4</title>
    ...
    <meta name="title" content="Pushmenu Plugin | AdminLTE 4" />
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../../../public/docs/javascript/pushmenu.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>PushMenu</p>
                    </a>
                  </li>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Pushmenu Plugin</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
