...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="Accessibility Module | AdminLTE 4" />
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../../../public/docs/javascript/accessibility.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Accessibility</p>
                    </a>
                  </li>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Accessibility Module</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Docs</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Accessibility Module</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
