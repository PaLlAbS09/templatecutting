        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../../public/docs/deployment.php" class="nav-link active">
...
<span class="line"><span style="color:#CE9178">  dist/</span><span style="color:#CE9178"> user@server:/var/www/your-app/</span></span></code></pre>
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="integrations.php">Recommended Integrations</a> — pick lightweight
                        libraries for the things AdminLTE doesn’t bundle
                      </li>
                      <li>
                        <a href="javascript/accessibility.php">Accessibility</a> — make sure your
