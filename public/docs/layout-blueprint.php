        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../../public/docs/layout-blueprint.php" class="nav-link active">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../../public/docs/javascript/card-widget.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Card Widget</p>
                    </a>
                  </li>
...
<span class="line"><span style="color:#808080">&lt;/</span><span style="color:#569CD6">footer</span><span style="color:#808080">&gt;</span></span></code></pre>
                    ...
                    <p>
                      The Layout section of the demo site (<code>/layout/*.php</code> files) ships
                      eleven pre-built combinations:
                    </p>
                    <ul>
                      <li>
                        <a href="../../public/layout/fixed-sidebar.php">Fixed Sidebar</a>,
                        <a href="../../public/layout/fixed-header.php">Fixed Header</a>,
                        <a href="../../public/layout/fixed-footer.php">Fixed Footer</a>,
                        <a href="../../public/layout/fixed-complete.php">Fixed Complete</a>
                      </li>
                      <li>
                        <a href="../../public/layout/unfixed-sidebar.php">Unfixed Sidebar</a>,
                        <a href="../../public/layout/sidebar-mini.php">Sidebar Mini</a>,
                        <a href="../../public/layout/collapsed-sidebar.php">Collapsed Sidebar</a>,
                        <a href="../../public/layout/collapsed-sidebar-without-hover.php"
                          >Collapsed without hover</a
                        >
                      </li>
                      <li>
                        <a href="../../public/layout/layout-custom-area.php">Layout Custom Area</a>,
                        <a href="../../public/layout/logo-switch.php">Logo Switch</a>,
                        <a href="../../public/layout/layout-rtl.php">Layout RTL</a>
                      </li>
                    </ul>
                    ...
                    <p>
                      ...
                      <a href="javascript/pushmenu.php">PushMenu plugin</a> — you don’t write them
                      yourself.
                    </p>
                    <h5 id="public-pitfalls">public pitfalls</h5>
                    <ul>
                      <li>
                        <strong
                      ...
                      <li>
                        ...
                        <a href="migration.php">Migration from v3</a>.
                      </li>
                      <li>
                        <strong
                    ...
                    <ul>
                      <li>
                        <a href="layout.php">Layout reference</a> — the lower-level CSS classes and
                        what they do
                      </li>
                      <li>
                        <a href="javascript/pushmenu.php">PushMenu plugin</a> — the sidebar toggle
                        implementation
                      </li>
                      <li>
                        <a href="customization.php">Customization</a> — how to change sidebar
