          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../../public/mailbox/inbox.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Inbox</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../../public/mailbox/read.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Read Message</p>
                    </a>
                  </li>
        ...
        <div class="app-content">
          <div class="container-fluid">
            <div class="row g-3">
              <!-- Folder sidebar -->
              <div class="col-lg-3">
                <a href="../../public/mailbox/compose.php" class="btn btn-primary w-100 mb-3">
